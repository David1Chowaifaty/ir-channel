...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '58ecad83a6ae585ed88d953653548dd9d02e9047' }, index.h("h4", { key: '298cc97a207c82e1c5d43dbade07d849e40596ef', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { class: 'close', onIconClickHandler: () => {
