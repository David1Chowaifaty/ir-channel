...
const irInterceptor_store = require('./ir-interceptor.store-b3a69ba7.js');
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0e2d7d9648e0bb589abef83bfb23144cedb979f8' }, index.h("ir-title", { key: '0bac17c12e66934653a3429f2ebab493432e8441', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '75fa4c6032d7a8944c000c012efd6bdc86b28a5b', class: "px-1" }, index.h("table", { key: 'bb42a9c09c9f9ca48905cdbea462a66d347984eb' }, index.h("thead", { key: '945cd76cbc264d0d8cb89ed5c57d6aed4e4f79a9' }, index.h("th", { key: '2afb1d97ddd98e29f42181d05864a11ed4361289', class: "sr-only" }, "room name"), index.h("th", { key: 'c292000305e361ba7987f6e5c344e1c7f7f73164', class: "sr-only" }, "housekeeper name"), index.h("th", { key: '4f8e135ef69ca289b51d7aec7a1211f2b14ec304', class: "sr-only" }, "actions")), index.h("tbody", { key: '1b4685ae7b2cf8cd3c6add51eea7f548a8990574' }, this.renderRooms())), index.h("div", { key: '2418a1f242decfe9b8e554234f98c8f204423dc2', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '65790ab713883a0857fe6c63b48587d71f13162f', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), index.h("ir-button", { key: '78a76786a195e6f4588d4095c032175d5a90a813', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHanlder: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd51902aacd451be851fc311ffb4f3d2eceaedbf0' }, index.h("ir-title", { key: '3fd99ee1ab14dbcb8693ada5f6d1369c8f1bcbc8', class: "px-1", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '06a446f71de13750421345979eb762a81caa52df', class: "px-1" }, index.h("ir-input-text", { key: 'b53c6edf796e26bb1cb198f7a23788df6af64b04', error: ((_b = (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.length) > 0, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this) }), index.h("ir-phone-input", { key: '760c8813b8c9e6469e5324b7584b74aba9630676', placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_d = (_c = this.errors) === null || _c === void 0 ? void 0 : _c.mobile) === null || _d === void 0 ? void 0 : _d.length) > 0, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_e = this.user) === null || _e === void 0 ? void 0 : _e.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("ir-input-text", { key: '16495fd951d90b99d260119571a609d73fba17e2', disabled: this.user !== null, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '82ac4448ad521a98e0db5a80d894c590c3a9f32f', label: locales_store.locales.entries.Lcz_Password, placeholder: locales_store.locales.entries.Lcz_MinimumCharacter, value: this.userInfo.password, type: "password", error: ((_g = (_f = this.errors) === null || _f === void 0 ? void 0 : _f.password) === null || _g === void 0 ? void 0 : _g.length) > 0, onTextChange: e => this.updateUserField('password', e.detail) }), index.h("ir-input-text", { key: '456ffbb05c0b07a06cb3b3b0a2f55313ecc6a452', label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) }), index.h("div", { key: 'c75d3f6b0771e1e1b3edfb46ea4312aec4b2f4cb', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: 'bb06fb9dd79bc4e61f1f2d9339dff2698a870247', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '7b526d375a46d264831bbe430c8af0b2488fde84', isLoading: this.isLoading, onClickHanlder: this.addUser.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: locales_store.locales.entries.Lcz_Save })))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '7ca72d7232c6b1b7415891122b91e5d982f4aa52' }, index.h("div", { key: '1262072bb695d2dbd095692c40fe9214ccc3c622', class: "form-group mr-0" }, index.h("div", { key: '5dd43b2de34b1e78729b931d5b7934fa05d9ee83', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '69658881c249c0bf8b79176e4262260155373182', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '652676d3e4c86bd77aec478a59509636e2fd5a12', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, index.h("img", { key: '3d191eb5b1035f0940768b9efb2e77f54b1455b9', src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }), index.h("svg", { key: 'c8d2f74b955741b7f4f71dbc55effa77255a0a0f', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '4a3a300f5dfa5b7d697b67d2ab34d7c0eddb7a17', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("label", { key: '737b8859d0ab107ac3d2fde5c46a8f601afe060e' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'c33ffcc9cba0a92cc807f331495f4090be67a733', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { class: "ir-dropdown-container" }, index.h("ir-combobox", { onComboboxValueChange: e => {
