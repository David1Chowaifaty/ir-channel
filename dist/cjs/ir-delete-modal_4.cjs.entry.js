...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3cf5ea709f5bbc9c6d80fa6204358bffca137657' }, index.h("ir-title", { key: 'da421aa2e5da02202cb1e3f2888fce83c2bc4b4f', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'e67b6082e100ce096e02192d211c1f2efc11b06e', class: "px-1" }, index.h("table", { key: '1279fe7e4fe3aa00a9d4c0e67227763e13149ea5' }, index.h("thead", { key: '7dc21f96d614377f18a79710f66fd2b906ac47a6' }, index.h("th", { key: '14323cb1cccf0dcd14ac3b922472aad6514bf526', class: "sr-only" }, "room name"), index.h("th", { key: 'd69ca27c5692f2a6702566e5103a1d77c85085cd', class: "sr-only" }, "housekeeper name"), index.h("th", { key: 'ea6e3f40c1b806df646b8559d38595aaf9473bb4', class: "sr-only" }, "actions")), index.h("tbody", { key: '7f5bb041a9ff4eddee89ccc1bc5a4d7ca4960c9b' }, this.renderRooms())), index.h("div", { key: '3c0b16675bc13321663d20bc20f9e570fce162b2', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '3350b1fbadcda4efdf4bafa3a2fd7bca388c9e18', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), index.h("ir-button", { key: '804221ffb902b286fee5d36830f91072e1130f33', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHanlder: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd903b35530557c95a1f10d5811c879adc154111f' }, index.h("ir-title", { key: '456e0d8e50cc7901e7cd2d1d4ea5d4c022c15d99', class: "px-1", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'ced8cca7cdff89f03adda79d8f5783b73d654eda', class: "px-1" }, index.h("ir-input-text", { key: '0cf04952c89703630479992d7044a701ed08adc3', error: ((_b = (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.length) > 0, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this) }), index.h("ir-phone-input", { key: 'dc28009d67835f27e42529ba1e6a78ff19f01d97', placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_d = (_c = this.errors) === null || _c === void 0 ? void 0 : _c.mobile) === null || _d === void 0 ? void 0 : _d.length) > 0, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_e = this.user) === null || _e === void 0 ? void 0 : _e.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("ir-input-text", { key: 'eea2d6938eb3a61ed3491b3836008230940e5668', disabled: this.user !== null, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '4410cde3326f1362596c7fb1d599a3843bfdba7f', label: locales_store.locales.entries.Lcz_Password, placeholder: locales_store.locales.entries.Lcz_MinimumCharacter, value: this.userInfo.password, type: "password", error: ((_g = (_f = this.errors) === null || _f === void 0 ? void 0 : _f.password) === null || _g === void 0 ? void 0 : _g.length) > 0, onTextChange: e => this.updateUserField('password', e.detail) }), index.h("ir-input-text", { key: 'da402525920607dee6c8eedc2ba52651d2ffd8fb', label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) }), index.h("div", { key: 'b7eb767d1e50351d17906f455cd3fa11b80b116c', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '52eb6d5cd9f52b5ce8fc6befbc1092e61e64ef3b', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '36c39987f6f338b842c33179c53d766d812029f3', isLoading: this.isLoading, onClickHanlder: this.addUser.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: locales_store.locales.entries.Lcz_Save })))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '6782e33f48eebc038538a5fb257992a55f91c17e' }, index.h("div", { key: 'b1e0fbcf71efc747e132d0c851e2970a9947abf9', class: "form-group mr-0" }, index.h("div", { key: 'd64321fe72c8326b97ec07c3097c72a9fd2ab46d', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '08f3067f956805264c9a5330a2f409259365a1e5', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '4ecf2073e091bb16e3a2ae5b15522b92f8e26ceb', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, index.h("img", { key: '757bec9e1f8a341fa53d0032630980fd14a86f9e', src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }), index.h("svg", { key: 'ed4e8f21e001e89a7438e34c74e25920e7fba9f7', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '8236df19ccc1634eedef6d1823e640a28dc702f2', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("label", { key: '899aea38e800fa02dbd146ce603d23ae3eafb57e' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'a9f4dccabeab56ef9ae57d43f0fd83b2cedc7768', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { class: "ir-dropdown-container" }, index.h("ir-combobox", { onComboboxValueChange: e => {
